...
export default function Home1() {
  ...
  return (
    <div className="min-h-screen bg-[#FBF8F3]">
      {/* Navigation */}
      <header style={{backgroundColor : "black"}} className="bg-white shadow-sm">
          ...
          <div className="flex items-center justify-between py-4">
            <div className="flex items-center">
              ...
              <nav className="hidden md:flex ml-10 space-x-8">
                <Link to={"/gallery"} style={{color : "white"}} className="text-gray-600 hover:text-gray-900">
                  Gallery
                </Link>
                <Link to={"/viewallalbumns"} style={{color : "white"}} className="text-gray-600 hover:text-gray-900">
                  View All Gallery
                </Link>
