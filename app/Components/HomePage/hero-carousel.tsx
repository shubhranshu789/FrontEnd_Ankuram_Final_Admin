...
export default function HeroCarousel() {
  const images = [
    ...
    {
      src: "/HomePics/1.jpg?height=400&width=500",
      alt: "Students collaborating",
    },

    {
      src: "/HomePics/2.jpg?height=400&width=500",
      alt: "Students collaborating",
    },
    {
      src: "/HomePics/3.jpg?height=400&width=500",
      alt: "Students collaborating",
    },
    {
      src: "/HomePics/4.jpg?height=400&width=500",
      alt: "Students collaborating",
    },
    {
      src: "/HomePics/5.jpg?height=400&width=500",
      alt: "Students collaborating",
    },
    {
      src: "/HomePics/6.jpg?height=400&width=500",
      alt: "Students collaborating",
    },
    {
      src: "/HomePics/7.jpg?height=400&width=500",
      alt: "Students collaborating",
    },
    {
      src: "/HomePics/8.jpg?height=400&width=500",
      alt: "Students collaborating",
    },
  ]
  ...
  return (
    ...
    <section
      className="py-8 md:py-8 bg-gray-50 w-full"
